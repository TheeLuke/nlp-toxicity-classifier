# run_exp_b.py
# (This is essentially your main.py but renamed for clarity)
import pandas as pd
import torch
...
def run_experiment_b():
    print("\n=== EXPERIMENT B: Hybrid Model + Augmentation ===")
    Config.set_seed()
    ...
    for epoch in range(Config.EPOCHS):
        ...
        if f1 > best_f1:
            best_f1 = f1
            torch.save(model.state_dict(), "exp_b_hybrid_aug.pth")

    print(f"Exp B Best F1: {best_f1:.4f}")
